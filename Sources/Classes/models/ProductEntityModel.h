...
//We should use @class instead of #import because we really just want a pointer to the ProductGroupModel parent. This should be a weak reference, and we shouldn't do anything that requires a strong reference. This prevents huge retain cycles.
//#import "ProductGroupModel.h"
@class ProductGroupModel;

@interface ProductEntityModel : SyndecaModel <DependencyInjection,Shareable>
...
#pragma mark - Properties
    ...
    @property (readwrite, strong) ProductGroupModel* parent;
